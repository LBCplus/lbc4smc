export default async function handler(req, res) {
  ...
  try {
    ...
    systemPrompt += "TRANSCRIPTS ARE PRIMARY EVIDENCE:
When meeting transcripts are provided, they contain the actual words spoken at meetings. Prioritize transcript evidence over meeting summaries. If a transcript shows someone using words like disrespect, bully, hostile, rude, or inappropriate, REPORT IT with the exact quote and date.
